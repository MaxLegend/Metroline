...
/**
 *
 * NOT_FORGET Сохранение области экрана работает некорректно
...
public class ImageUtil {
    ...
    private static void drawWorldContent(Graphics2D g2d, WorldScreen screen, World world,
        ...
        // Рисуем поезда
        drawTrains(g2d, world, x, y, width, height);

        // Рисуем игровые объекты
        drawGameplayUnits(g2d, world, x, y, width, height);
    ...
    /**
     * Рисует поезда в указанной области
     */
    private static void drawTrains(Graphics2D g2d, World world,
            int x, int y, int width, int height) {
    ...
    /**
     * Рисует игровые объекты в указанной области
     */
    private static void drawGameplayUnits(Graphics2D g2d, World world,
            int x, int y, int width, int height) {
        if (world instanceof GameWorld) {
            GameWorld gameWorld = (GameWorld) world;
            Rectangle2D area = new Rectangle2D.Float(x, y, width, height);

            for (GameplayUnits unit : gameWorld.getGameplayUnits()) {
