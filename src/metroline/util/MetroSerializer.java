...
public class MetroSerializer {
    ...
    public void saveWorld(GameWorld world, String filename) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(
            ...
            for (java.util.Map.Entry<Station, Long> entry : world.stationBuildStartTimes.entrySet()) {
            ...
            for (java.util.Map.Entry<Station, Long> entry : world.stationDestructionStartTimes.entrySet()) {
                Station station = entry.getKey();
                writer.write(String.format(
                        "{stationId:%d,start:%d,duration:%d}\n",
                        station.getUniqueId(),
            ...
            for (java.util.Map.Entry<Tunnel, Long> entry : world.tunnelBuildStartTimes.entrySet()) {
            ...
            for (java.util.Map.Entry<Tunnel, Long> entry : world.tunnelDestructionStartTimes.entrySet()) {
                Tunnel tunnel = entry.getKey();
                writer.write(String.format(
                        "{startId:%d,endId:%d,startTime:%d,duration:%d}\n",
                        tunnel.getStart().getUniqueId(),
